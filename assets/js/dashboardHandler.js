...
function setActiveDashboardScreen(e) {
    ...
    if(dashboardFeedbackScreen == null) {
    ...
    feedbacksRequestedBtn.addEventListener('click', async (e) => {
        ...
        if(feedback != null) {
                ...
                feedbackForm.innerHTML = `
                        ...
                        <p>Review for : ${feedback.reviewee.name}</p>
                        <p>Assigned by : ${feedback.assignedBy.name}</p>
