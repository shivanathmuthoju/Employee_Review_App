...
if(feedbacksAssignBtn != null) {
    ...
    feedbacksAssignBtn.addEventListener('click', async (e) => {
        ...
        let feedbacksConatiner = document.querySelector(".dashboard-feedbacks-container");
        feedbacksConatiner.innerHTML = ""
        if(employees.length < 3) {
            ...
            feedbacksConatiner.appendChild(imageContainer)
                ...
                await feedbacksConatiner.appendChild(assignFormContainer);
...
if(feedbacksReceivedBtn != null) {
    ...
    feedbacksReceivedBtn.addEventListener('click', (e) => {
        styleActiveFeedbackBtns(e);
...
if(feedbacksRequestedBtn != null) {
    ...
    feedbacksRequestedBtn.addEventListener('click', async (e) => {
        ...
        let feedbacks = await fetch('/profile/getRequestedFeedbacks').then((res) => res.json())
        ...
        if(feedbacks.length > 0) {
            for(let feedback of feedbacks) {
                ...
                feedbackForm.innerHTML = `
                        ...
                        <textarea name="feedbackDescription" id="feedbackDescription" class="credentials_input" row="5" col="33">Feedback(Optional)</textarea>
